  ...
  const registerUser = async () => {
    try {
      if (!name || !email || !password)
        return toast.error("Please enter name, email & Password");
        ...
        <div class="mt-8">
          <div class="flex flex-col mb-2">
            <div class="flex relative ">
              ...
              <input
                type="text"
                class=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-sky-600 focus:border-transparent"
